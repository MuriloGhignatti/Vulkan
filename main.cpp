...
class HelloTriangleApplication {
  ...
  private:
    ...
    void createGraphicsPipeline() {
        ...
        VkPipelineRasterizationStateCreateInfo rasterzizer{};
        rasterzizer.sType =
            VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO;
        rasterzizer.depthClampEnable = VK_FALSE;
        rasterzizer.polygonMode = VK_POLYGON_MODE_FILL;
        rasterzizer.lineWidth = 1.0f;
        rasterzizer.cullMode = VK_CULL_MODE_BACK_BIT;
        rasterzizer.frontFace = VK_FRONT_FACE_CLOCKWISE;
        rasterzizer.depthBiasEnable = VK_FALSE;
        ...
        pipelineInfo.pRasterizationState = &rasterzizer;
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer,
        ...
        if (vkEndCommandBuffer(commandBuffer) != VK_SUCCESS) {
            throw std::runtime_error("failed to record command buffr!");
        }
    }
